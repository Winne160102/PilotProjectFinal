package com.example.pilotprojectfinal.common.util;
...
public class FileHelper {
	...
	public static String editFile(String parentFolderPath, MultipartFile[] files, String oldFilePath)
		...
		String newFileName = CommonUtil.cvDateToString(new Date(), Constant.DATE_FORMAT_FOR_FILE_NAME) + Constant.COMMON_HYPHEN + randomStr;
		String rootFolderPath = System.getProperty(Constant.PROP_KEY_ROOT_FOLDER);
